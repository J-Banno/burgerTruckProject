    ...
    <section className="presBlock">
      ...
      <div className="firstPresBlock">
        ...
        <p className="textPresBlock">
          Food-Truck spécialisé dans les hamburgers, Gilles à la cuisine et Elsa
          à la vente s’évertuent à vous proposer une gamme d’hamburgers
          gourmets.
          <br />
          <br />
          Tous nos plats sont élaborés dans notre camion avec des ingrédientsf
          frais et de qualité renouvelé chaque jour. A l’heure du déjeuner venez
          déguster nos burger maisons.
        </p>
      </div>
      ...
      <div className="secondPresBlock ">
        <p className="textPresBlock">
          Chez Burger Truck nous respectons la chaîne du froid, et sommes équipé
          pour convectionner vos commande dans des mesures d’hyiènes les plus
          strictes.
        </p>
      </div>
